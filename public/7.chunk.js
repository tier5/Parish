...
var ListAreaComponent = (function () {
    /** Injecting services to be used in this component */
    function ListAreaComponent(router, pzapService) {
        this.router = router;
        this.pzapService = pzapService;
        this.responseMsg = '';
