...
var CreateReportComponent = (function () {
    ...
    CreateReportComponent.prototype.ngOnInit = function () {
        ...
        if (user_type == 3) {
            this.pzapService.getPenalty()
                ...
                if (response.json().status) {
                    _this.penalty_percent = response.json().penalty_percent;
                }
            }, function (error) {
                if (error.status === 401) {
        ...
        this.prForm.valueChanges
            ...
            var penalty = (monthTemp.monetary.total * _this.penalty_percent) / 100;
            var total = monthTemp.monetary.total + penalty;
            _this.progress_report.report.monthly_total.monetary.total = total;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ViewChild"])('prForm'),
...
ReportRoutingModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* RouterModule */].forChild(reportRoutes)],
