...
LoginRoutingModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* RouterModule */].forChild(loginRoutes)],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__wem_list_wem_service__ = __webpack_require__("../../../../../src/app/wem-list/wem.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_service__ = __webpack_require__("../../../../../src/app/dashboard/dashboard.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = (function () {
    /** Service injection */
    function LoginComponent(pzapService, loginService, router, profileService, paymentService, reportService, wemService, dashboardService) {
    ...
    LoginComponent.prototype.onSubmit = function (formSignIn) {
        ...
        this.loginService.login(body)
            ...
            if (response.json().status) {
                ...
                _this.wemService.refreshHeader();
                _this.dashboardService.refreshHeader();
            }
            else {
...
var LoginService = (function () {
    ...
    LoginService.prototype.login = function (body) {
        var header = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["a" /* Headers */]({ 'X-Requested-With': 'XMLHttpRequest' });
