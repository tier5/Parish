...
var RemoteData = (function (_super) {
    ...
    RemoteData.prototype.search = function (term) {
        ...
        if (!this._requestOptions) {
            ...
            this._requestOptions.headers = this._headers || new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        }
...
var ServerDataSource = (function (_super) {
    ...
    ServerDataSource.prototype.createRequestOptions = function () {
        var requestOptions = {};
        requestOptions.params = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* URLSearchParams */]();
